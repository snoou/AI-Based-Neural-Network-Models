...
train_data = datasets.MNIST(root=ROOT, train=True, download=False, transform=train_transforms) 
test_data = datasets.MNIST(root=ROOT, train=False, download=False, transform=test_transforms)
